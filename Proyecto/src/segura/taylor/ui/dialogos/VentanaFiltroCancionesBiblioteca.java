...
import segura.taylor.controlador.interfaz.cliente.ControladorBibliotecaCliente;

public class VentanaFiltroCancionesBiblioteca {
    ...
    public void mostrar() {
        try {
            ...
            //Actualizar campos
            chbFiltroNombre.setSelected(ControladorBibliotecaCliente.filtrandoPorNombre);
            chbFiltroArtista.setSelected(ControladorBibliotecaCliente.filtrandoPorArtista);
            chbFiltroGenero.setSelected(ControladorBibliotecaCliente.filtrandoPorGenero);
    ...
    public void cambioFiltroNombre() {
        ControladorBibliotecaCliente.filtrandoPorNombre = chbFiltroNombre.isSelected();
    }

    public void cambioFiltroArtista() {
        ControladorBibliotecaCliente.filtrandoPorArtista = chbFiltroArtista.isSelected();
    }

    public void cambioFiltroGenero() {
        ControladorBibliotecaCliente.filtrandoPorGenero = chbFiltroGenero.isSelected();
    }
}
